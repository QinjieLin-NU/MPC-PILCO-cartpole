...
@LastEditTime: 2020-05-25 17:17:54
@Description:
'''
from mpc.models.base import Model, MLPRegression,DiffDynamics
import numpy as np
import torch
import torch.nn as nn
from mpc.models.differential_model import DifferentiableCartPole
...
class DynamicModel(Model):
    def __init__(self, NN_config):
        ...
        if model_config["load_model"]:
            ...
            init_params = [0.5,0.4,0.5]
            self.model = CUDA(DiffDynamics(self.state_dim,self.action_dim,init_params,DifferentiableCartPole()))
